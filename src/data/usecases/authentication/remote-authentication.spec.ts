...
describe('RemoteAuthentication', () => {
  ...
  describe('Errors', () => {
    ...
    test('Should throw UnexpectError if HttpPostClient returns 400',
      async () => {
        const { sut, httpPostClientSpy } = makeSut()
        httpPostClientSpy.response = {
    ...
    test('Should throw UnexpectError if HttpPostClient returns 500',
      async () => {
        const { sut, httpPostClientSpy } = makeSut()
        httpPostClientSpy.response = {
  ...
  describe('Success', () => {
    test('Should return an AccountModel if HttPostClient returns 200',
      async () => {
        const { sut, httpPostClientSpy } = makeSut()
